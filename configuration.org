...
Completion utility ([[https://oremacs.com/swiper/]]). The one thing I don't like about this system is the "fuzzy" matching for M-x commands. You have to match the first letter. Not good. Is there something better than ~ivy--regex-fuzzy~ available?
