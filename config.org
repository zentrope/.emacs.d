...
- [[https://github.com/Malabarba/smart-mode-line][smart-mode-line home page]]
...
#+begin_src emacs-lisp :tangle yes
  (use-package atom-one-dark-theme
    ...
    (defun kfi-dark ()
      ...
      (set-face-attribute 'mode-line          nil :family "Input Mono Narrow" :height 100 :weight 'thin
                          ;;:box '(:line-width 2 :color "gray15" :style nil)
                          )
      (set-face-attribute 'mode-line-inactive nil :family "Input Mono Narrow" :height 100 :weight 'thin
                          ;;:box '(:line-width 2 :color "gray15" :style nil)
                          )
